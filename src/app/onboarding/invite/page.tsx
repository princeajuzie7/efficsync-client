...
export default function Page() {
  return (
    <div>
      {" "}
      <main
        className="main relative h-screen flex flex-col bg-white transition-transform"
        ...
        >
                  ...
                  <div className="relative">
                    ...
                    <div className="p-6 text-left">
                      ...
                      <div className="mt-2 flex items-start justify-between gap-2 sm:mt-6 md:flex-row">
                        <button
                          type="submit"
                          className="border border-mix bg-mix hover:bg-purplerain text-white font-bold px-2 py-1 text-sm flex items-center justify-center rounded-lg transition-all h-10 w-full bg-[#2563EB]"
          ...
          <div className="flex gap-2 mt-4  sm:mt-8 sm:flex  items-center justify-center text-center">
            ...
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="h-[10px] w-[10px] text-dust text-[#2563EB]"
            >
              <circle cx={2} cy={2} r={2} fill="currentColor" />
            </svg>
          </div>
