...
import CompanyImg from "@/resources/svg/company.svg";
import TeamImg from "@/resources/svg/team.svg";
import SingleImg from "@/resources/svg/single.svg";
import Image from "next/image";
export default function Page() {
  return (
    <div>
      <main
        className="main h-screen relative flex flex-col bg-white transition-transform"
        ...
        >
          ...
          <div className="w-full flex-col items-center justify-center px-4 py-10 sm:flex md:p-0">
            <h1 className="mb-2 text-center text-ay-h3 text-night sm:text-left sm:text-ay-h2">
              {" "}
              What are you planning to <strong>use Efficsync for?</strong>
            </h1>
            ...
            <div className="flex w-full max-w-[900px] flex-col items-center gap-6 md:gap-10">
              ...
              <button
                type="button"
                className="border border-mix bg-mix hover:bg-purplerain text-white font-bold px-2 py-1 text-sm flex items-center justify-center rounded-lg transition-all h-10 w-full sm:w-[280px] bg-[#2563EB]"
              ...
              <div className="flex gap-2 mt-4 hidden sm:mt-8 sm:flex">
                <svg
                  ...
                  fill="#ffffff"
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-[10px] w-[10px] text-mix bg-white text-[#2563EB]"
                >
